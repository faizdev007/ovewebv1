...
type clientD = {
    ...
    rating?:any;
    featuredImage?:any;
    nodes?:{title?:string;slug?:string;content?:string;rating?:any;featuredImage?:any;}
}
...
const Client: React.FC<TestimonialData> = ({hire,cData}) => {
    ...
    return(
        <>  
            <section className="pb-12 dark:py-12 bg-black flex flex-col gap-6 relative px-4 py-2 sm:px-6 lg:px-8 mx-auto">
                ...
                <TestimonialDev cTestimonial={cData?.nodes}/>
            </section>
        </>
    );
};
