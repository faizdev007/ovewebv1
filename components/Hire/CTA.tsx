    ...
    <>   
        <section className="text-white pb-12 dark:py-12 flex flex-col items-center gap-6 relative px-4 sm:px-6 lg:px-8 mx-auto">
            ...
            <div className="flex gap-3 items-center">
                <a href={'/contact-us'} aria-label="contact" className="rounded-md border-3 flex items-center gap-2 border-black bg-gray-900 px-4 py-2 hover:bg-gray-700"><span dangerouslySetInnerHTML={{ __html: hire?.ctaButtonText ?? 'Contact Us'}}/>
