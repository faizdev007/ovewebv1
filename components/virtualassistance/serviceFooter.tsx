                    ...
                    <div className="mx-auto grid gap-10 lg:grid-cols-5">
                        ...
                        <div className="flex flex-col justify-between">
                            ...
                            <div className="flex gap-1 justify-center items-center mt-10">
                                <Image className="dark:bg-white px-1 rounded-2xl h-auto" src={'/assets/ssl-secure.webp'} width={120} height={60}  alt={'ssl-secure'}/>
                                <Image className="h-auto" src={'/assets/GDPR.webp'} width={120} height={60}  alt={'GDPR'}/>
                            </div>
                        </div>
                        </div>
                    </div>
