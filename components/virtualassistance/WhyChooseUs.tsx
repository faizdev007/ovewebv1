...
export default function ServiceWhyChooseUs( Expertise : any) {
  ...
  const roleTitleHTML = Expertise?.Expertise?.title ?? "Why You Should Choose OVE";
    ...
    <section className="bg-gradient py-12 dark:py-12 flex flex-col gap-6 relative px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="mt-4 text-lg mb-4">
                <span dangerouslySetInnerHTML={{ __html: Expertise?.Expertise?.description  as string ?? 'This is text will'}} />
            </div>
        </div>
